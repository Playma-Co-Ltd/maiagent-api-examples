...
{
    public static class SendImageMessage
    {
        ...
        public static async Task Main(string[] args)
        {
            ...
            Debug.Assert(IMAGE_PATH != "<your-image-path>", "Please set your image path");
            ...
            // 上傳附件
            var uploadAttachmentResponse = await maiagentHelper.UploadAttachmentAsync(conversationId!, IMAGE_PATH);

            // 發送訊息
            var attachments = new List<string>
            {
                uploadAttachmentResponse.GetProperty("id").GetString()!
            };

            var response = await maiagentHelper.SendMessageAsync(conversationId!, TEXT_MESSAGE, attachments);
